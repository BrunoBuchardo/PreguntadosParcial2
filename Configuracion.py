...
def mostrar_configuracion(pantalla, eventos, datos_juego, fuente, fuente_game_over):
    """
    ...
    # BOTON SUBIR/BAJAR VOLUMEN
    dibujar_boton(pantalla, fuente, "Subir Volumen", 300, 300, 200, 50, AMARILLO, AZUL, 
                  lambda: datos_juego.update(volumen_musica=subir_volumen(datos_juego)[0]))
    dibujar_boton(pantalla, fuente, "Bajar Volumen", 300, 360, 200, 50, AMARILLO, AZUL, 
                  lambda: datos_juego.update(volumen_musica=bajar_volumen(datos_juego)[0]))
    
    # BOTON VOLVER
    dibujar_boton(pantalla, fuente, "Volver", 300, 420, 200, 50, AMARILLO, AZUL, 
