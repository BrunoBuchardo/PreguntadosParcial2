...
def mostrar_config_juego(pantalla, eventos, datos_juego, fuente, fuente_game_over):
    ...
    dibujar_boton(pantalla, fuente, "Fácil", 200, 300, 150, 50, AMARILLO, VERDE, 
                  lambda: datos_juego.update(dificultad_seleccionada="FACIL"))
    dibujar_boton(pantalla, fuente, "Medio", 375, 300, 150, 50, AMARILLO, VERDE, 
                  lambda: datos_juego.update(dificultad_seleccionada="MEDIO"))
    dibujar_boton(pantalla, fuente, "Difícil", 550, 300, 150, 50, AMARILLO, VERDE, 
                  lambda: datos_juego.update(dificultad_seleccionada="DIFICIL"))
    dibujar_boton(pantalla, fuente, "Volver", 300, 400, 200, 50, AMARILLO, AZUL, 
