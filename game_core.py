...
from Opciones_de_Juego import mostrar_config_juego
...
def cargar_recursos():
    """Carga recursos multimedia (imágenes, sonidos, GIFs)."""
    recursos = {}
    try:
    ...
    try:
        ...
        s = pygame.Surface((ANCHO, ALTO)).convert_alpha(); s.fill(BLANCO)
    ...
    try:
        ...
        s2 = pygame.Surface((100, 100)).convert_alpha(); s2.fill(BLANCO)
    ...
    try:
        ...
        sf = pygame.Surface((ANCHO, ALTO)).convert_alpha(); sf.fill(BLANCO)
...
def principal():
    ...
    estado_funciones = {
        ...
        OPCIONES_DE_JUEGO: mostrar_config_juego,
