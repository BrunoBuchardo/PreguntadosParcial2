"""" Este archivo implementa el bucle principal del juego, maneja las animaciones y sonidos, 
y responde a las interacciones del jugador a medida que avanzan las preguntas y estados del juego."""
